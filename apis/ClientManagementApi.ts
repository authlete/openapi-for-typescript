...
export class ClientManagementApi extends BaseAPI {
     ...
     */
    clientGrantedScopesDeleteApi({ clientId, subject }: ClientGrantedScopesDeleteApiRequest): Observable<Result>
    clientGrantedScopesDeleteApi({ clientId, subject }: ClientGrantedScopesDeleteApiRequest, opts?: OperationOpts): Observable<AjaxResponse<Result>>
    clientGrantedScopesDeleteApi({ clientId, subject }: ClientGrantedScopesDeleteApiRequest, opts?: OperationOpts): Observable<Result | AjaxResponse<Result>> {
