...
export class DynamicClientRegistrationApi extends BaseAPI {
     ...
     */
    clientRegistrationGetApi({ clientRegistrationRequest }: ClientRegistrationGetApiRequest): Observable<ClientRegistrationResponse>
    clientRegistrationGetApi({ clientRegistrationRequest }: ClientRegistrationGetApiRequest, opts?: OperationOpts): Observable<AjaxResponse<ClientRegistrationResponse>>
    clientRegistrationGetApi({ clientRegistrationRequest }: ClientRegistrationGetApiRequest, opts?: OperationOpts): Observable<ClientRegistrationResponse | AjaxResponse<ClientRegistrationResponse>> {
        throwIfNullOrUndefined(clientRegistrationRequest, 'clientRegistrationRequest', 'clientRegistrationGetApi');
