...
export interface Service {
    ...
    /**
     * The flag indicating whether to remove the `openid` scope from a new access token issued by the refresh token flow if the presented refresh token does not contain the `offline_access` scope. 
     * @type {boolean}
     * @memberof Service
     */
